...
<?php if (have_posts()) : ?>
    <?php while (have_posts()) : ?>
        ...
        <main class="home bg-background ">
            ...
            <!-- Background Image -->
            <!-- <img class="" src="<?= $banniere["background_image"]["url"] ?>" alt="<?= $banniere["background_image"]["alt"] ?>"> -->
            <div class="z-10 bg-primary inset-0 absolute opacity-20"></div>
            <div class="relative flex flex-col justify-center h-full z-20 p-24 space-y-20">  
          
            <h1 class=" text-white"><?= $banniere["titre"]?></h1>
            <div>
